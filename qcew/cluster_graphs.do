...
use "$datadir/bartik_results_moe_new.dta", clear;
...
twoway (hist beta if iteration!=0 )
	...
	graph export "$graphdir/beta_bartik_distribution_moe_new.png", replace; 
	graph export "$graphdir/qcew_betadist.png", replace ; 
/*************************************
...
twoway (hist tstat if iteration!=0)
	...
	graph export "$graphdir/qcew_tstatdist.png", replace;  
